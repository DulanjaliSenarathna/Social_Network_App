	...
	<div class="row">
		<div class="col-sm-12">
			<div class="main-content">
				<div class="header">
					<h3 style="text-align: center;"><strong>Login to WeChat</strong></h3>
				</div>
				<div class="1-part">
					<form action="" method="post">
						<input type="email" class="form-control input-md" placeholder="Email" name="email" required="required"><br>
						<div class="overlap-text">
							<input type="password" class="form-control input-md" placeholder="Password" name="pass" required="required"><br>
