...
if(isset($_POST['sign_up']))
{
	...
	if($rand == 1)
		$profile_pic = "man.png";
	if($rand == 2)
		$profile_pic = "woman.png";
	if($rand == 1)
		$profile_pic = "child.png";

	$insert = "insert into users (f_name,l_name,user_name,describe_user,Relationship,user_pass,user_email,user_country,user_gender,user_birthday,user_image,user_cover,user_reg_date,status,posts,recovery_account) values('$first_name','$last_name','$username','This is my default status','...','$pass','$email','$country','$gender','$birthday','$profile_pic','default_cover.jpg',NOW(),'$status','$posts','I want to updating')";
